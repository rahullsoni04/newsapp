...
const NewsFeed = (props) => {
  ...
  document.title = `${capitalizeFirstLetter(props.category)}- News Villa`;

  const handlePage = async ()=>{
    props.setProgress(10)
    let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=${props.api_key}&pageSize=${props.page_size}&page=${page_no}`;
